...
function createThemeFromAccent(accentHex) {
  ...
  return {
    'color-scheme': 'dark',
    '--bg': '#050608',
    '--body-gradient': `radial-gradient(circle at top, ${withAlpha(highlight, 0.18)}, transparent 50%), var(--bg)`,
    '--shell-bg': 'rgba(2, 6, 12, 0.78)',
    '--shell-border': withAlpha(accent, 0.2),
    '--shell-shadow': withAlpha(secondary, 0.28),
    '--shell-backdrop': 'blur(14px) saturate(140%)',
    '--accent': accent,
    ...
    '--logo-mark-glow': withAlpha(accent, 0.8),
...
const themePresets = {
  signal: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#050608',
      '--body-gradient': 'radial-gradient(circle at 18% 18%, rgba(0, 245, 212, 0.25), transparent 52%), radial-gradient(circle at 82% 22%, rgba(0, 168, 255, 0.18), transparent 56%), var(--bg)',
      '--shell-bg': 'rgba(2, 6, 12, 0.78)',
      ...
      '--logo-mark-glow': 'rgba(0, 245, 212, 0.8)',
      ...
      '--panel-bg': 'rgba(3, 12, 18, 0.8)',
      '--hero-overlay': 'rgba(0, 168, 255, 0.06)',
      '--text': '#E6F7FF',
      '--muted': 'rgba(230, 247, 255, 0.6)',
      '--grid-line': 'rgba(0, 245, 212, 0.16)',
      '--slot-bg': 'rgba(8, 18, 28, 0.6)',
  ...
  aurora: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#03060D',
      '--body-gradient': 'radial-gradient(circle at 16% 20%, rgba(112, 214, 255, 0.3), transparent 50%), radial-gradient(circle at 80% 12%, rgba(199, 125, 255, 0.35), transparent 55%), var(--bg)',
      '--shell-bg': 'rgba(6, 10, 24, 0.82)',
      '--shell-border': 'rgba(112, 173, 255, 0.24)',
      '--shell-shadow': 'rgba(112, 214, 255, 0.28)',
      '--shell-backdrop': 'blur(18px) saturate(165%)',
      '--accent': '#70D6FF',
      ...
      '--logo-mark-glow': 'rgba(199, 125, 255, 0.75)',
      ...
      '--hero-overlay': 'rgba(112, 214, 255, 0.12)',
      '--text': '#F3F5FF',
      '--muted': 'rgba(243, 245, 255, 0.6)',
      '--grid-line': 'rgba(112, 214, 255, 0.2)',
  ...
  ember: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#0D0403',
      '--body-gradient': 'radial-gradient(circle at 20% 20%, rgba(255, 120, 79, 0.22), transparent 50%), radial-gradient(circle at 82% 14%, rgba(255, 190, 11, 0.24), transparent 56%), var(--bg)',
      '--shell-bg': 'rgba(26, 10, 6, 0.85)',
      '--shell-border': 'rgba(255, 126, 95, 0.24)',
      '--shell-shadow': 'rgba(255, 120, 79, 0.3)',
      '--shell-backdrop': 'blur(16px) saturate(150%)',
      '--accent': '#FF784F',
      ...
      '--logo-mark-glow': 'rgba(255, 120, 79, 0.75)',
  ...
  terminal: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#020502',
      '--body-gradient': 'radial-gradient(circle at 15% 18%, rgba(94, 252, 141, 0.22), transparent 50%), radial-gradient(circle at 85% 22%, rgba(29, 185, 84, 0.2), transparent 54%), var(--bg)',
      '--shell-bg': 'rgba(4, 12, 4, 0.85)',
      '--shell-border': 'rgba(94, 252, 141, 0.22)',
      '--shell-shadow': 'rgba(29, 185, 84, 0.28)',
      '--shell-backdrop': 'blur(16px) saturate(160%)',
      '--accent': '#5EFC8D',
      ...
      '--logo-mark-glow': 'rgba(94, 252, 141, 0.8)',
      ...
      '--hero-overlay': 'rgba(94, 252, 141, 0.1)',
      '--text': '#DFFFE9',
      '--muted': 'rgba(223, 255, 233, 0.65)',
      '--grid-line': 'rgba(94, 252, 141, 0.2)',
  ...
  prismatic: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#040311',
      '--body-gradient': 'radial-gradient(circle at 18% 18%, rgba(255, 94, 180, 0.4), transparent 45%), radial-gradient(circle at 82% 16%, rgba(112, 214, 255, 0.38), transparent 52%), radial-gradient(circle at 50% 82%, rgba(0, 245, 212, 0.32), transparent 55%), #040311',
      '--shell-bg': 'rgba(14, 6, 24, 0.86)',
      '--shell-border': 'rgba(255, 94, 180, 0.28)',
      '--shell-shadow': 'rgba(112, 214, 255, 0.32)',
      '--shell-backdrop': 'blur(20px) saturate(210%)',
      '--accent': '#FF5EB4',
      '--accent-secondary': '#70D6FF',
      '--accent-soft': 'rgba(255, 94, 180, 0.22)',
      '--logo-inner-glow': 'rgba(255, 94, 180, 0.32)',
      '--logo-outer-glow': 'rgba(112, 214, 255, 0.4)',
      '--logo-bg-start': 'rgba(255, 94, 180, 0.24)',
      '--logo-bg-end': 'rgba(112, 214, 255, 0.18)',
      '--logo-mark-glow': 'rgba(255, 94, 180, 0.8)',
      '--sound-border': 'rgba(112, 214, 255, 0.48)',
      '--sound-shadow': 'rgba(112, 214, 255, 0.35)',
      '--sound-active-border': 'rgba(255, 94, 180, 0.52)',
      '--sound-active-shadow': 'rgba(255, 94, 180, 0.36)',
      '--panel-bg': 'rgba(12, 8, 28, 0.85)',
      '--hero-overlay': 'rgba(112, 214, 255, 0.12)',
      '--text': '#F7F4FF',
      '--muted': 'rgba(247, 244, 255, 0.7)',
      '--grid-line': 'rgba(112, 214, 255, 0.2)',
      '--slot-bg': 'rgba(16, 12, 34, 0.78)',
      '--slot-border': 'rgba(255, 94, 180, 0.26)',
      '--footer-muted': 'rgba(247, 244, 255, 0.54)',
      '--scanline': 'rgba(112, 214, 255, 0.12)',
      '--scanline-speed': '3.5s',
  ...
  horizon: {
    ...
    values: {
      'color-scheme': 'dark',
      '--bg': '#090604',
      '--body-gradient': 'linear-gradient(135deg, rgba(255, 190, 11, 0.28) 0%, rgba(255, 111, 97, 0.16) 40%, transparent 70%), radial-gradient(circle at 50% 120%, rgba(255, 214, 165, 0.25), transparent 55%), var(--bg)',
      '--shell-bg': 'rgba(24, 10, 4, 0.86)',
      '--shell-border': 'rgba(255, 190, 11, 0.24)',
      '--shell-shadow': 'rgba(255, 135, 58, 0.3)',
      '--shell-backdrop': 'blur(18px) saturate(180%)',
      '--accent': '#FFBE0B',
      '--accent-secondary': '#FB5607',
      '--accent-soft': 'rgba(255, 190, 11, 0.2)',
      '--logo-inner-glow': 'rgba(255, 190, 11, 0.26)',
      '--logo-outer-glow': 'rgba(251, 86, 7, 0.32)',
      '--logo-bg-start': 'rgba(255, 190, 11, 0.2)',
      '--logo-bg-end': 'rgba(251, 86, 7, 0.14)',
      '--logo-mark-glow': 'rgba(255, 190, 11, 0.7)',
      '--sound-border': 'rgba(255, 190, 11, 0.44)',
      '--sound-shadow': 'rgba(255, 190, 11, 0.3)',
      '--sound-active-border': 'rgba(251, 86, 7, 0.5)',
      '--sound-active-shadow': 'rgba(251, 86, 7, 0.32)',
      '--panel-bg': 'rgba(28, 12, 4, 0.82)',
      '--hero-overlay': 'rgba(255, 190, 11, 0.12)',
      '--text': '#FFEFE0',
      '--muted': 'rgba(255, 230, 204, 0.66)',
      '--grid-line': 'rgba(255, 190, 11, 0.22)',
      '--slot-bg': 'rgba(32, 14, 6, 0.74)',
      '--slot-border': 'rgba(251, 86, 7, 0.24)',
      '--footer-muted': 'rgba(255, 230, 204, 0.52)',
      '--scanline': 'rgba(255, 190, 11, 0.12)',
      '--scanline-speed': '9s',
      '--scanline-opacity': '0.26',
      '--noise-mode': 'lighten',
      '--noise-opacity': '0.2',
    },
  },
  monolith: {
    label: 'Monolith Minimal',
    values: {
      'color-scheme': 'light',
      '--bg': '#FFFFFF',
      '--body-gradient': 'linear-gradient(180deg, #FFFFFF 0%, #F6F7F8 55%, #F2F3F4 100%)',
      '--shell-bg': 'rgba(255, 255, 255, 0.92)',
      '--shell-border': 'rgba(0, 0, 0, 0.08)',
      '--shell-shadow': 'rgba(17, 17, 17, 0.06)',
      '--shell-backdrop': 'blur(4px) saturate(110%)',
      '--accent': '#111111',
      '--accent-secondary': '#444444',
      '--accent-soft': 'rgba(0, 0, 0, 0.06)',
      '--logo-inner-glow': 'rgba(0, 0, 0, 0.12)',
      '--logo-outer-glow': 'rgba(0, 0, 0, 0.16)',
      '--logo-bg-start': 'rgba(0, 0, 0, 0.03)',
      '--logo-bg-end': 'rgba(0, 0, 0, 0.07)',
      '--logo-mark-glow': 'rgba(0, 0, 0, 0.18)',
      '--sound-border': 'rgba(0, 0, 0, 0.12)',
      '--sound-shadow': 'rgba(0, 0, 0, 0.08)',
      '--sound-active-border': 'rgba(0, 0, 0, 0.28)',
      '--sound-active-shadow': 'rgba(0, 0, 0, 0.18)',
      '--panel-bg': 'rgba(255, 255, 255, 0.86)',
      '--hero-overlay': 'rgba(0, 0, 0, 0.05)',
      '--text': '#111111',
      '--muted': 'rgba(17, 17, 17, 0.54)',
      '--grid-line': 'rgba(0, 0, 0, 0.08)',
      '--slot-bg': 'rgba(255, 255, 255, 0.72)',
      '--slot-border': 'rgba(0, 0, 0, 0.12)',
      '--footer-muted': 'rgba(17, 17, 17, 0.44)',
